import { Zap, Phone, Mail, MessageSquare, Plus } from "lucide-react";
...
export default function Workflows() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0b0b] text-slate-200">
      ...
      {/* MAIN */}
      <main className="px-4 sm:px-6 lg:px-8 py-8 lg:ml-64">
        {/* HEADER */}
        ...
        {/* EMPTY STATE */}
        <div className="flex flex-col items-center text-center mt-16 sm:mt-24">
          ...
          <p className="text-sm text-slate-400 max-w-md mt-2">
            ...
            reminders so you can build processes around your events.
          </p>
